...
const en = {
  ...
  // ---- election dashboard
  "ed.title": "Election dashboard",
  "ed.overview": "National overview",
  "ed.status": "Status",
  "ed.pollingDay": "Polling day",
  "ed.lastUpdated": "Last updated",
  "ed.source": "Official source",
  "ed.constituencies": "Constituencies",
  "ed.candidates": "Candidates",
  "ed.voters": "Registered voters",
  "ed.pollingStations": "Polling stations",
  "ed.seatsDeclared": "Seats declared",
  "ed.countingStatus": "Counting",
  "ed.countingNotStarted": "No results published",
  "ed.official": "Official figure",
  "ed.recorded": "Recorded here",
  "ed.gap": "figures differ",
  "ed.standings": "Party standings",
  "ed.won": "Won",
  "ed.leading": "Leading",
  "ed.members": "Members",
  "ed.share": "Vote share",
  "ed.distribution": "Distribution",
  "ed.basisResults": "Seats won, from verified results.",
  "ed.basisMembership":
    "No verified results are published for this election. The figures below count sitting members recorded by NetaTrack, not seats won at the count.",
  "ed.membershipNote":
    "Member records were cross-checked against a published member list. They describe the current composition of the house, which can differ from the election result after by-elections or changes of affiliation.",
  "ed.map": "Seats by province",
  "ed.mapNote": "Select a province to filter the results below.",
  "ed.mapDisclaimer":
    "Schematic, not a geographic map. Tiles run west to east in provincial order; NetaTrack does not hold boundary data and will not approximate national borders.",
  "ed.mapPrOnly":
    "Only first-past-the-post seats appear here. Proportional representation members are elected from national lists and belong to no single constituency.",
  "ed.explorer": "Constituency results",
  "ed.filters": "Filter",
  "ed.allProvinces": "All provinces",
  "ed.allDistricts": "All districts",
  "ed.allParties": "All parties",
  "ed.allStatuses": "Any result status",
  "ed.declared": "Declared",
  "ed.pending": "Awaiting result",
  "ed.searchPlaceholder": "Constituency, district or candidate",
  "ed.apply": "Apply",
  "ed.clear": "Clear filters",
  "ed.noMatch": "No constituencies match those filters",
  "ed.noMatchHint": "Try removing a filter, or clear them all to see every seat.",
  "ed.showing": "Showing",
  "ed.of": "of",
  "ed.awaiting": "Awaiting result",
  "ed.awaitingHint": "No verified result has been published for this seat yet.",
  "ed.margin": "Margin",
  "ed.comparison": "Previous elections",
  "ed.comparisonNote":
    "Elections at the same level of government. Declared counts reflect verified results held by NetaTrack, not necessarily the full official record.",
  "ed.thisElection": "This election",
...
const ne: Partial<Record<TranslationKey, string>> = {
  ...
  // ---- निर्वाचन ड्यासबोर्ड
  "ed.title": "निर्वाचन ड्यासबोर्ड",
  "ed.overview": "राष्ट्रिय सिंहावलोकन",
  "ed.status": "स्थिति",
  "ed.pollingDay": "मतदान दिन",
  "ed.lastUpdated": "पछिल्लो अद्यावधिक",
  "ed.source": "आधिकारिक स्रोत",
  "ed.constituencies": "निर्वाचन क्षेत्र",
  "ed.candidates": "उम्मेदवार",
  "ed.voters": "दर्ता मतदाता",
  "ed.pollingStations": "मतदान केन्द्र",
  "ed.seatsDeclared": "घोषित सिट",
  "ed.countingStatus": "मतगणना",
  "ed.countingNotStarted": "परिणाम प्रकाशित छैन",
  "ed.official": "आधिकारिक अङ्क",
  "ed.recorded": "यहाँ अभिलेख",
  "ed.gap": "अङ्क फरक छ",
  "ed.standings": "दलगत अवस्था",
  "ed.won": "विजयी",
  "ed.leading": "अग्रता",
  "ed.members": "सदस्य",
  "ed.share": "मत हिस्सा",
  "ed.distribution": "वितरण",
  "ed.basisResults": "प्रमाणित परिणामबाट प्राप्त विजयी सिट।",
  "ed.basisMembership":
    "यस निर्वाचनको प्रमाणित परिणाम प्रकाशित छैन। तलका अङ्कले NetaTrack मा अभिलेख भएका बहालवाला सदस्य गणना गर्छन्, मतगणनाबाट जितेका सिट होइन।",
  "ed.membershipNote":
    "सदस्य अभिलेख प्रकाशित सदस्य सूचीसँग भिडाइएको हो। यसले सदनको हालको संरचना देखाउँछ, जुन उपनिर्वाचन वा दल परिवर्तनपछि निर्वाचन परिणामभन्दा फरक हुन सक्छ।",
  "ed.map": "प्रदेश अनुसार सिट",
  "ed.mapNote": "तलका परिणाम छान्न प्रदेश छान्नुहोस्।",
  "ed.mapDisclaimer":
    "यो सङ्केतात्मक हो, भौगोलिक नक्सा होइन। टाइलहरू पश्चिमबाट पूर्व प्रदेश क्रममा छन्; NetaTrack सँग सिमाना तथ्याङ्क छैन र राष्ट्रिय सिमानाको अनुमान गर्दैन।",
  "ed.mapPrOnly":
    "यहाँ पहिलो हुने निर्वाचित सिट मात्र देखिन्छन्। समानुपातिक सदस्य राष्ट्रिय सूचीबाट निर्वाचित हुन्छन् र कुनै एक क्षेत्रसँग सम्बन्धित हुँदैनन्।",
  "ed.explorer": "क्षेत्रगत परिणाम",
  "ed.filters": "छान्नुहोस्",
  "ed.allProvinces": "सबै प्रदेश",
  "ed.allDistricts": "सबै जिल्ला",
  "ed.allParties": "सबै दल",
  "ed.allStatuses": "कुनै पनि परिणाम स्थिति",
  "ed.declared": "घोषित",
  "ed.pending": "परिणाम कुर्दै",
  "ed.searchPlaceholder": "क्षेत्र, जिल्ला वा उम्मेदवार",
  "ed.apply": "लागू",
  "ed.clear": "फिल्टर हटाउनुहोस्",
  "ed.noMatch": "कुनै क्षेत्र मिलेन",
  "ed.noMatchHint": "कुनै फिल्टर हटाएर हेर्नुहोस्, वा सबै हटाएर सम्पूर्ण सिट हेर्नुहोस्।",
  "ed.showing": "देखाइएको",
  "ed.of": "मध्ये",
  "ed.awaiting": "परिणाम कुर्दै",
  "ed.awaitingHint": "यस सिटको प्रमाणित परिणाम अझै प्रकाशित भएको छैन।",
  "ed.margin": "अन्तर",
  "ed.comparison": "विगतका निर्वाचन",
  "ed.comparisonNote":
    "समान तहका निर्वाचन। घोषित सङ्ख्याले NetaTrack सँग भएका प्रमाणित परिणाम देखाउँछ, पूर्ण आधिकारिक अभिलेख नै भन्न सकिँदैन।",
  "ed.thisElection": "यही निर्वाचन",
  "ed.share.copy": "लिङ्क प्रतिलिपि",
  "ed.share.title": "साझा गर्नुहोस्",
  "ed.noElection": "निर्वाचन अभिलेख फेला परेन",
};
