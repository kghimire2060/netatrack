...
const GROUPS: { group: TranslationKey; items: { href: string; label: TranslationKey; permission: string }[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/admin/projects", label: "cand.projects", permission: "project.manage" },
      { href: "/admin/statements", label: "cand.statements", permission: "statement.manage" },
      { href: "/admin/media", label: "cand.mediaEvidence", permission: "media.manage" },
